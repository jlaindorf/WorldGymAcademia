<template>
  ...
  <v-form ref="form">
    <v-row align="center" justify="center">
      <v-col cols="6">
        <v-text-field label="Nome do Aluno" prepend-icon="mdi-account-search" v-model="aluno"
          :rules="[value => !!value || 'É obrigatório colocar o Nome']"></v-text-field>
  ...
  <v-table>
    ...
    <tbody>
      <tr v-for="aluno in listaAlunos" :key="aluno.name">
        ...
        <td> <v-btn size="Small" @click.prevent="setUpTtrainning(aluno.id)" color="blue" variant="tonal">Montar
            treino</v-btn></td>
