   ...
   <v-form ref="form" @submit="cadastraAluno">
      ...
      <v-container>
         <v-row>
            ...
            <v-col cols="12" sm="6">
               <v-text-field :rules="[value => !!value || 'Nome é obrigatório']" label="Nome Completo" ref="nomeField"
                  v-model="nome" variant="outlined"></v-text-field>
            </v-col>
            ...
            <v-col cols="12" sm="6">
               <div>
                  <VueDatePicker placeholder="Data De Nascimento" :max="new Date()" locale="pt-BR"
                     :enable-time-picker="false" v-model="data" type="date" />
      ...
      <v-btn :disabled="!formularioValido" type="submit" color="blue" variant="tonal">Cadastrar</v-btn>
   </v-form>
</template>
